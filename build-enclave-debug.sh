...
nitro-cli build-enclave --docker-uri ${FILE}:latest --output-file ${BUILD}${FILE}.eif --name ${NAME} --version ${VER} > ${BUILD}${PCRS} # --private-key ${BUILD}${KEY} --signing-certificate ${BUILD}${CRT} 
